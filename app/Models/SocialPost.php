 ...
 * discrimina o destino (tiktok, youtube, instagram, ...) — 1 linha por
 * postagem disparada.
 *
 * Quem cria/atualiza essas linhas é o job PostShortToPlatformJob (via
 * Posters registrados no PosterRegistryService).
 *
 * @property int $id
