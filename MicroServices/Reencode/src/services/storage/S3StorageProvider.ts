...
export class S3StorageProvider implements IStorageProvider {
    ...
    public async uploadFile(localPath: string, key: string): Promise<void> {
        ...
        logger.info(`  Enviando: ${key} (${(size / 1024 ** 2).toFixed(2)} MB)`);
        // ContentLength explícito: com um Readable stream o SDK não consegue
        // inferir o tamanho e recusaria a assinatura sem ele.
