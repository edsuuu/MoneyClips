<div @if ($hasPending) wire:poll.5s @endif>
    <div class="flex items-center justify-between">
        ...
        <x-ui.button variant="primary" href="{{ route('uploads.create') }}">Enviar vídeo</x-ui.button>
    </div>
    ...
    <div class="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        @empty
            <div class="col-span-full rounded-2xl border border-dashed border-slate-700 px-8 py-16 text-center">
